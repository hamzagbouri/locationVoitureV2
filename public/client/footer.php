                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex space-x-4">
                            <a href="javascript:void(0)" class="block">
                                <img src="assets/img/logo/logo-footer-1.png" alt="logo-footer-1" class="w-24 h-auto">
                            </a>
                            <a href="javascript:void(0)" class="block">
                                <img src="assets/img/logo/logo-footer-2.png" alt="logo-footer-2" class="w-24 h-auto">
                            </a>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-2">
                            ...
                            <li><a href="javascript:void(0)" class="hover:underline">Car Rentals</a></li>
